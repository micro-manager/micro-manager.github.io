...
<span>'''August 3, 2006'''</span><br /><br /> If you like and use [http://rsb.info.nih.gov/ij/ ImageJ], or have limited resources, Micro-Manager would be your natural choice: it is free, integrated with ImageJ and supports a decent number of cameras and other devices. Also, if you are new to microscopy you will appreciate its simple and uncluttered user interface that makes it really easy to get started. But if you do have a nice budget, or if you already use another software package, you'll have to make a tough decision whether to invest time and energy in Micro-Manager, or go with some of the established commercial solutions.<br /><br /> We think you should definitely try Micro-Manager if:<br />
...
To determine if Micro-Manager can be useful to you right away, you should first check if it has all the features you need by quickly going through the [http://valelab.ucsf.edu/~MM/MMwiki/index.php/Micro-Manager_User%27s_Guide User's Guide]. If it looks like it doesn't do exactly what you need out-of-the-box, you can let us know what features you would like to see in future or check whether they are already in the works. You can also consider extending the Micro-Manager on your own.<br /><br /> Second, you should check whether your hardware is already [[Device_Support|supported]]. If not, contact us and express your desire and we'll let you know if we plan to support it. If your hardware is supported, you will still need to spend some time and effort to configure Î¼Manager for your system. To get an idea of what it takes to configure the Micro-Manager for your hardware setup, have a look at the [http://valelab.ucsf.edu/~MM/MMwiki/index.php/Micro-Manager_Configuration_Guide Configuration Guide].<br />
{{Overview_Sidebar}}
