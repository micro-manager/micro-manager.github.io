...
<table><tr><td>
'''Summary:'''</td><td>Controls [http://www.ximea.com/en/products/scientific-cameras/ XIMEA cameras] (and some Olympus Soft Imaging cameras)</td></tr>
<tr><td>'''Author:'''</td><td>Marian Zajko</td></tr>
<tr><td>'''License:'''</td><td>BSD</td></tr> 
<tr><td>'''Platforms:'''</td><td>Windows</td></tr>
<tr><td>'''Devices:'''</td><td>XIMEA FireWire, USB2 and USB3 cameras. Can also be used for XM-10 and XC-10 cameras from Olympus Soft Imaging.</td></tr>
<tr><td>'''Supported MM version:'''</td><td>1.4.6 20110722</td></tr>
<tr><td>'''Driver Needed:'''</td><td>[http://www.ximea.com/support/wiki/apis/XIMEA_API_Software_Package/ XIMEA camera drivers]</td></tr>
</table>
...
* Download and install the [http://www.ximea.com/support/wiki/vision-libraries/Micro-Manager XIMEA API Software package], during install '''API''' and '''Drivers''' section must be selected
...
{{Note|As of Micro-Manager nightly build 20140908 (pre-1.4.19), XIMEA API (beta) 4.01.76 is required.<br />As of Micro-Manager 1.4.21, XIMEA API 4.04.00 is required.<br />As of nightly build 20151015 (pre-1.4.23), XIMEA API (beta) 4.05.58 is required.}}
...
{{Note|As of nightly builds starting 20180404, no longer rename xiapi64.dll.  Just copy that file to the Micro-Manager directory.}}
{{Note|As of nightly builds starting 20180404, the naming scheme of the camera has been changed.  If your configuration file stops working, you may need to open it in a text editor, find a line that looks like: "Device,FastCam,XIMEACamera, 9652450", and replace the space in front of the camera number with a "0", resulting in: "Device,FastCam,XIMEACamera,09652450".}}
{{Note|As of nightly builds starting 20180404, changes were made to property names.  Your configuration file may stop working, but can probably be easily fixed.  For instance, I had to change "Mono 12" to "Mono16" to get my configuration file to work again.}}
...
For contacting XIMEA product support regarding any questions or issues, visit [http://www.ximea.com/support/ online support].

{{Listserv_Search|XIMEA}}
