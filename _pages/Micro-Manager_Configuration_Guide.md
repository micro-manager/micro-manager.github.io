...
![Startup screen](media/Startup.gif "Startup screen")  
...
![Hardware wizard step 2](media/Wizardstep2.png "Hardware wizard step 2")  
...
![Configuration Presets](media/Presets.gif "Configuration Presets")  
...
![Preset Editor](media/GroupEditor.png "Preset Editor")  
...
![Pixel Size Calibration Editor](media/Calibration.gif
...
Threads...**), and the sequence buffer size (**Tools | Options**) can be
changed. These each need to be large enough for what they are used for,
but small enough to leave RAM for the other, and for the Operating
System.
