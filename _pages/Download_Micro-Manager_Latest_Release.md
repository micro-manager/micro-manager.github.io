...
Micro-Manager 2.0 is the actively developed, current, version of Micro-Manager that you should use unless there is functionality in 1.4 that you need. 1.4 is no longer developed (except for the ASI diSPIM plugin). Nightly builds are usually fine to use, and have the latest features and bug fixes.  If you encounter a bug in a release version, always test with the latest nightly build to see if the bug has been fixed already. 
...
* [https://valelab4.ucsf.edu/~MM/builds/2.0/Windows/MMSetup_64bit_2.0.0.exe Windows 64-bit], 148 MB<br />
* [https://valelab4.ucsf.edu/~MM/builds/2.0/Windows/MMSetup_32bit_2.0.0.exe Windows 32-bit], 143 MB<br />
Requires Windows7-10. Windows 10 recommended. Device drivers may have other requirements.<br />

* [https://valelab4.ucsf.edu/~MM/builds/2.0/Mac/Micro-Manager-2.0.0.dmg Mac OS X (Universal Binary)], 111 MB<br />
Requires Mac OS X 10.5 or greater. Device drivers may have other requirements.<br />
(if the application does not open when double-clicked for the first time, try ctrl-click or right click, then select "Open".)
...
* [https://github.com/micro-manager/pycro-manager Pycro-Manager]
...
* [https://valelab4.ucsf.edu/~MM/nightlyBuilds/2.0/Windows/ '''Version 2.0 (Windows)'''] (you most likely want the 64-bit version)
* [https://valelab4.ucsf.edu/~MM/nightlyBuilds/2.0/Mac/ '''Version 2.0 (Mac)''']
...
* [https://valelab4.ucsf.edu/~MM/builds/1.4/Windows/64bit/MMSetup_64bit_1.4.22.exe Windows 64-bit], 87 MB<br />
* [https://valelab4.ucsf.edu/~MM/builds/1.4/Windows/32bit/MMSetup_32bit_1.4.23.exe Windows 32-bit], 84 MB<br />
Requires Windows7-10. Windows 10 recommended. Device drivers may have other requirements.<br />

* [https://valelab4.ucsf.edu/~MM/builds/1.4/Mac/Micro-Manager1.4.23.dmg Mac OS X (Universal Binary)], 76 MB<br />
Requires Mac OS X 10.5 or greater. Device drivers may have other requirements.<br />
(if the application does not open when double-clicked for the first time, try ctrl-click or right click, then select "Open".)
