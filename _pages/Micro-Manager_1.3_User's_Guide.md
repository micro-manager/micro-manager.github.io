...
![Startup screen](media/Main_panel.gif "Startup screen")  
...
![Image acquisition window](media/Image_window3.jpg
...
![Acquisition Dialog](media/Acq_dialog.png "Acquisition Dialog")  
...
and an [Image
Viewer](Micro-Manager_User's_Guide#Image5D_Viewer "wikilink") window
...
Viewer](Micro-Manager_User's_Guide#Image5D_Viewer "wikilink").)
...
acquisition](#Multi-dimensional_acquisition "wikilink") dialog. However,
...
![Burst Acquisition Dialog](media/Burst_mode.gif "Burst Acquisition Dialog")  
...
in the [Image5D Viewer](#Image5D_Viewer "wikilink"). When saving to disk
...
buffer can be specified in the **Tools | Options menu**. Default size is
relatively modest (25 MB) and can be increased to almost all available
RAM. However, allocating large chunks of the available memory to the
buffer may impair overall performance and limit the size of the time
lapse sequences in other acquisition modes.
...
![5D image window](media/Image_5d.gif "5D image window")  
...
Acquisition](#Multi-dimensional_acquisition "wikilink") window. You can
