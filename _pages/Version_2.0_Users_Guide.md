...
![Main Window](media/UsersGuide_mainWindow.png "Main Window")
...
These settings allow you to control how images are acquired.
  ...
  - Exposure: sets the exposure time for images. "Exposure time" in
    µManager always refers to the *camera* exposure time, not the
...
![Image Window axis scrollbars](media/UsersGuide_imageWindowAxes.png
"Image Window axis scrollbars")
...
![Image Window Settings](media/UsersGuide_imageWindowSettings.png
...
![Line Profile on an image](media/UsersGuide_lineProfileImage.png
"Line Profile on an image")

The Line Profile menu option will then show you a graph like this:

![Line Profile Graph](media/UsersGuide_lineProfile.png "Line Profile Graph")
...
![Export Images Dialog](media/UsersGuide_exportImages.png
...
![Histograms gear menu](media/UsersGuide_histogramGears.png
"Histograms gear menu")
...
![Single histogram panel](media/UsersGuide_singleHistogramHighlighted.png
...
![Single histogram name and color](media/UsersGuide_histogramName.png
"Single histogram name and color")
...
![Histogram view scale](media/UsersGuide_histogramScale.png
"Histogram view scale")
...
![Histogram statistics](media/UsersGuide_histogramStats.png
...
![MDA Custom Timepoints](media/UsersGuide_mdaCustomTimes.png
"MDA Custom Timepoints")
...
![MDA Acquisition Order](media/UsersGuide_mdaOrder.png
"MDA Acquisition Order")

![MDA Acquisition Order dropdown menu](media/UsersGuide_mdaOrder2.png
"MDA Acquisition Order dropdown menu")
...
![Create Config Group 2](media/UsersGuide_createGroup2.png
"Create Config Group 2")
...
![Newly-created Config Group](media/UsersGuide_newConfigGroup.png
"Newly-created Config Group")
...
![Create Second Preset](media/UsersGuide_createPreset2.png
"Create Second Preset")

Now our preset has two options:

![Config Group Dropdown Menu](media/UsersGuide_configGroupDropdown.png
"Config Group Dropdown Menu")
...
position, by clicking on the "\>" buttons. You can adjust the step size
corresponding to each button using the text fields at the bottom. If you
have performed a [\#Pixel Calibration](#Pixel_Calibration "wikilink"),
then you can use the buttons to set default step sizes for the XY
movement buttons of 1 pixel, a tenth of a field of view, and a full
field of view.

Note that the current stage position is always displayed in the main
window, along the bottom:

![Main window with stage position
indicated](media/UsersGuide_mainWindowWithStagePosition.png
"Main window with stage position indicated")
...
![Pixel Size Calibration dialog](media/UsersGuide_pixelSizeDialog.png
"Pixel Size Calibration dialog")
...
![Create new pixel size config](media/UsersGuide_newPixelSize.png
"Create new pixel size config")
...
![Create new pixel size group](media/UsersGuide_newPixelSizeGroup.png
...
![Create new pixel size group 2](media/UsersGuide_newPixelSizeGroup2.png
"Create new pixel size group 2")
...
![Stage Position List Dialog](media/UsersGuide_stagePositionList.png
"Stage Position List Dialog")
...
![Merge Stage Position](media/UsersGuide_mergePosition.png
"Merge Stage Position")
...
![Create Grid dialog](media/UsersGuide_createGridDialog.png
"Create Grid dialog")
...
![Create Grid "Center Here"](media/UsersGuide_createGridCenterHere.png
"Create Grid \"Center Here\"")
...
![Create Grid manual positioning](media/UsersGuide_createGridManual.png
"Create Grid manual positioning")
...
![Create Grid result list](media/UsersGuide_createGridResults.png
"Create Grid result list")

## Device Property Browser

![Device Property Browser](media/UsersGuide_devicePropertyBrowser.png
"Device Property Browser")
...
![Hardware Configuration Wizard](media/UsersGuide_hardwareConfigWizard.png
...
The Tools menu contains a variety of miscellaneous tools.
  ...
  - Multi-Dimension Acquisition: opens the [\#Multi-Dimensional
    Acquisition](#Multi-Dimensional_Acquisition "wikilink") window.
...
µManager to unload and then reload the current configuration. Any time
a hardware config file is loaded, µManager's GUI is refreshed to reflect
...
![Slide Explorer](media/UsersGuide_slideExplorer.png "Slide Explorer")
...
![HCS Site Generator](media/UsersGuide_hcsPlugin.png "HCS Site Generator")
...
![Quick Access Panel Menu](media/UsersGuide_quickAccessMenu.png
"Quick Access Panel Menu")
...
![Quick Access Panel Window](media/UsersGuide_quickAccessWindow.png
"Quick Access Panel Window")
...
![Quick Access Panel edit mode](media/UsersGuide_quickAccessWindowEdit.png
"Quick Access Panel edit mode")
...
![Script Panel](media/UsersGuide_scriptPanel.png "Script Panel")
...
![Keyboard Shortcuts Adding](media/UsersGuide_shortcuts2.png
...
![Keyboard Shortcut Actions](media/UsersGuide_shortcutActions.png
...
![On-The-Fly Image Processing](media/UsersGuide_onTheFlyProcessing.png
"On-The-Fly Image Processing")
