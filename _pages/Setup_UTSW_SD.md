...
! Components
| colspan="2" |
* [[NikonTI | Ti-E Microscope with TIRF and Intensilight (Nikon)]]
* [[Prior | XY + NanoScanZ stage (Prior)]]
* [[Yokogawa | CSUX1 Spinning Disk Confocal head (Yokogawa)]]
* [[SutterLambda | Filterwheel and smart shutter (Sutter)]]
* [[Andor | iXon EMCCD camera (Andor)]]
* [[AndorSDK3 | Neo sCMOS Camera (Andor)]]
* (No DeviceAdapter) FRAPPA  (Andor)
* Dell T3600 PC
|}
...
* Learned that one has to put the <code>MMStartup.bsh</code> startup script in the µManager root folder.  First instinct was to put it in the "scripts" folder, which didn't work.
...
=== Python scripts ===
* [https://gist.github.com/omsai/5214107 FRAPPA bypass]
* [https://gist.github.com/omsai/1872080 Laser shutter]
