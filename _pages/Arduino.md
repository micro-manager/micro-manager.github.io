...
2](media/Micro-manager_bb.png
"Figure: Functional pinout set by firmware version 2") ([Image source
.svg file](:File:media/Micro-manager_bb.svg.media/Tar.gz "wikilink"))
...
the `Arduino-Switch-State` to 32 (i.e. 2^5) in the `Device/Property
Browser`. Toggle the `Arduino-Shutter` in the main MM window (the output
pins will only go high when the Shutter Device is open, so you will need
both the Shutter and State devices).
...
about 1 kHz. It is possible to [go up
to 30-60kHz](https://www.arduino.cc/en/Tutorial/SecretsOfArduinoPWM).
...
![TLV5618\media/_wiring.png](media/TLV5618_wiring.png "media/TLV5618_wiring.png")
...
![media/TLV5618-linearity.png](media/TLV5618-linearity.png "media/TLV5618-linearity.png")

**Response time**:

![TLV5618\media/_response.png](media/TLV5618_response.png "media/TLV5618_response.png")
