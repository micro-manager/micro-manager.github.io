...
2.  Select New &gt; New Project... &gt; Java &gt; **Java Class
    Library**.
    <img src="media/Netbeans8_new_project.png" title="fig:media/Netbeans8_new_project.png" width="450" alt="media/Netbeans8_new_project.png" />
...
5.  Then choose Libraries &gt; Compile &gt; Add JAR/Folder.
    ...
    2.  Click Add JAR/Folder again and add
        ...
        <img src="media/Netbeans8_library_tab.png" title="fig:media/Netbeans8_library_tab.png" width="450" alt="media/Netbeans8_library_tab.png" />
    3.  Click Categories &gt; Run and set Main Class to `ij.ImageJ`,
        working directory to `C:\Program Files\Micro-Manager-1.4\` .
        Click OK.
        <img src="media/Netbeans8_run_tab.png" title="fig:media/Netbeans8_run_tab.png" width="450" alt="media/Netbeans8_run_tab.png" />
