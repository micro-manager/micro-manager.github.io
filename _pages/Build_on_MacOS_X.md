{{Note|This page is up to date for SVN r13224.}}
...
<div style="width:625px"><pre>./configure --enable-imagej-plugin=/path/to/ImageJ \
...
JAVACFLAGS="-Xlint:all,-serial -source 1.6 -target 1.6"</pre></div>
