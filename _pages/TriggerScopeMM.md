...
!Summary:
|Adapter for the [http://www.triggerscope.com/ TriggerScope] using Micro-Manager firmware
|-
!Author:
|Nico Stuurman, based on code by Austin Blanco
|-
!License:
|LGPL
|-
...
This adapter was written for "MM" firmware.  Download from [https://github.com/micro-manager/TriggerScopeMM/ its Github repository] and install using the [https://www.arduino.cc/en/Main/Software Arduino IDE].
