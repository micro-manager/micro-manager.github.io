...
| Prolific     | PL-2303 4-port USB-serial                                        | works, but on Windows 7 you must use the older [Windows XP driver](:File:media/PL2303_DriverInstaller_v1413_20110219.gz) or the COM port will intermittently lock up |
