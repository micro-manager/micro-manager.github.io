...
|- valign="top"
!Maintainers
|Alan Mullan (Andor)<br/>Niall Flanagan (Andor)
|- valign="top"
!Documentation:
...
{{MessageBox|Required Driver Limited availability notice|You will need the Andor Driver Pack 3 (sCMOS).  This driver pack is currently not publicly available.  Please contact Andor and ask them to provide you with the latest version of this Driver Pack.  Public access will be restored soon.}}
...
See Andor's
[https://andor.oxinst.com/learning/view/article/setting-up-and-using-andors-scmos-camera-range-in-the-micro-manager Setup Video] which details the steps above, shows how to add a device in the property browser, etc.
