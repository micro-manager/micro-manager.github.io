...
The metadata.txt file contains a [http://json.org JSON] key-value map. This version is supposed to be readable from Micro-Manager 1.3. The first key is "Summary". Here is an example (object keys sorted for clarity):
