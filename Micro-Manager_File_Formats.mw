...
<h1> Programming using Image file stacks </h1>
...
<span class="source"> TaggedImageStorageMultipageTiff stackReader = new TaggedImageStorageMultipageTiff("C:\Data\Directory where data set is", false, null, false, false);</span><br />
...
<span class="source"> 
summary = new JSONObject();  <br />
summary.put("Slices", 18;  <br />
summary.put("Positions", 1);  <br />
summary.put("Channels", 2);  <br />
summary.put("Frames", 10);  <br />
summary.put("Positions",3);  <br />
summary.put("SlicesFirst",true);  <br />
summary.put("TimeFirst",false);  <br />
summary.put("PixelType", "GRAY16");  <br />
summary.put("Width",512);  <br />
summary.put("Height",512);  <br />
summary.put("Prefix","Put the desired base filename here");  <br />
//these are used to create display settings  <br />
summary.put("ChColors", new org.json.JSONArray("[1,1]"));  <br />
summary.put("ChNames", new org.json.JSONArray("["DAPI","FITC"]"));  <br />
summary.put("ChMins", new org.json.JSONArray("[0,0]"));  <br />
summary.put("ChMaxes", new org.json.JSONArray("[65535,65535]"));  <br />
</span> <br />
...
<span class="source"> 
TaggedImageStorageMultipageTiff storage = new TaggedImageStorageMultipageTiff("C:/Data/Directory where you want to save",true,summary,false,true);  <br />
</span> <br />

Important methods for writing images are:

<span class="source"> 
public void putImage(TaggedImage taggedImage)  <br />
