...
<ul>
<li>ITC18-Hub: This device must be loaded. It is the core device that opens the ITC18 hardware</li>
<li>ITC18-Shutter: This device controls TTL-controllable shutter attached to any of the TTL Outputs (0-15)</li>
<li>ITC18-DAC: Sets a voltage on a DA port (0-3)</li>
<li>ITC18-ADC: Reads a voltage on a AD port (0-7)</li>
<li>ITC18-Protocol: This device loads an external imaging protocol- '''should only be used by very advanced users'''</li>
</ul>
...
As root, create a file called /etc/udev/rules.d/99-itc18.rules with the following content:
  <blockquote>ATTRS{idVendor}=="1482", ATTRS{idProduct}=="0011", MODE="0660", GROUP="users"</blockquote>
...
--[[User:Kdb|Karl Bellve, Biomedical Imaging Group, University of Massachusetts]] 17:15, 10 November 2009 (UTC)
