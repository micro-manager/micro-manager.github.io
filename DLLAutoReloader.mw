...
# Once Micro-Manager is running, choose DLL Auto Reloader from the plugins menu.
# Click the single button, and choose a directory where a copy of your device adapter's updated DLLs are saved. This location may be bin_Win32, bin_x64, or the directory where Visual Studio is generating the DLL.
